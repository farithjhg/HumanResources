...
public class HRUtility {
    ...
    public static void asignarMensajeError(String texto){
        ...
        fc.addMessage(null, new FacesMessage(FacesMessage.SEVERITY_ERROR, texto, texto));
    }

    public static void asignarMensajeAdvertencia(String texto){
        FacesContext fc = FacesContext.getCurrentInstance();
        fc.addMessage(null, new FacesMessage(FacesMessage.SEVERITY_WARN, texto, texto));
    }

    public static void asignarMensajeInfo(String texto){
        FacesContext fc = FacesContext.getCurrentInstance();
        fc.addMessage(null, new FacesMessage(FacesMessage.SEVERITY_INFO, texto, texto));
    }
